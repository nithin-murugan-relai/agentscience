...
export default async function ConnectPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="page-enter mx-auto max-w-[var(--content-width)]">
      ...
      {/* ── Mac app card ──────────────────────────────────── */}
      <div className="mt-10 rounded-[var(--radius-lg)] border-2 border-accent/30 bg-snow-white p-8 text-center">
      ...
      <div className="mt-10 border-t border-rule pt-6 text-center">
        <p className="text-xs text-ink-faint">
          Need help?{" "}
          <Link href="/method" className="text-ink-light hover:text-ink underline underline-offset-2">
