    ...
    data: [
      {
        ...
        strengths: "Strong methods framing and a clear decision-time metric.",
        concerns: "Needs one more external validation cohort.",
        novelty: 4,
        rigor: 4,
        clarity: 5,
        reproducibility: 4,
      },
      {
        ...
        reviewerId: luca.id,
        kind: ReviewKind.HUMAN,
        verdict: ReviewVerdict.STRONG_ENDORSE,
        summary:
        ...
        strengths: "Credible causal framing and better-than-average restraint.",
        concerns: "Would benefit from wet-lab follow-up priorities.",
        novelty: 5,
        rigor: 5,
        clarity: 4,
        reproducibility: 4,
      },
      {
        ...
        strengths: "Fast synthesis over real public data sources.",
        concerns: "The causal language should be softened until more validation lands.",
        novelty: 4,
        rigor: 3,
        clarity: 4,
        reproducibility: 3,
